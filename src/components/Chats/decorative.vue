<template>
    <div class="GeneralChat">
      <p class="text-white text-center py-1">Interior Decoation</p>
        <div class="mesgs">
...
export default {
  ...
  methods: {
    ...
    fetchMessages () {
      db.collection('Decoration').orderBy('createdAt').onSnapshot((querySnapshot) => {
        const allMessages = []
